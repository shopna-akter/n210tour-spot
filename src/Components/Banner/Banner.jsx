        ...
        <>
            ...
            >
                <SwiperSlide>
                    ...
                    <img src="https://i.ibb.co/ys7p9n2/pexels-photo-24377.jpg" alt="" className="w-full" />
                </SwiperSlide>
                <SwiperSlide>
                    <div className="text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <img src="https://i.ibb.co/51V7Y93/paragliding-in-mountains.jpg" alt="" className="w-full" />
                </SwiperSlide>
                <SwiperSlide>
                    <div className="text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <img src="https://i.ibb.co/gP6BHpc/lake-moraine.jpg" alt="" className="w-full" />
                </SwiperSlide>
                <SwiperSlide>
                    <div className="text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        <h1 className="text-4xl font-bold text-center lg:text-left">Invest in Your Future</h1>
                    ...
                    <img src="https://i.ibb.co/ykjFn22/Whats-App-Image-2024-04-26-at-22-02-01-866c03ad.jpg" alt="" className="w-full" />
                </SwiperSlide>
            </Swiper>
